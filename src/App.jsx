...
function App() {
  ...
  onKeyDownRef.current = e => {
    ...
    // Shift toggle: fires on keydown for instant response. The modeRef
    // sync in switchMacrosMenu prevents double-toggle on rapid taps.
    // Guard: skip if another modifier is held (Ctrl+Shift+V, Cmd+Shift, etc.)
